      module solver
        logical           :: time_stepping = .true.     ! if time stepping is enabled
        integer           :: maxiter       = 200        ! maximum non-linear iteration of solver
        real              :: EPS           = 1e-10      ! small number to avoid zero division
        ...
        real              :: safety_factor = 0.9        ! safety factor
